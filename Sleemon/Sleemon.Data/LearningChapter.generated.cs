...
namespace Sleemon.Data
{
    ...
    public partial class LearningChapter
        : Entity
    {
        public LearningChapter()
        {
        }
        ...
        [Column(Name = "CourseId", DbType = "Int32", CanBeNull = false)]
        ...
        private ICollection<LearningFile> _LearningFile;
        public virtual ICollection<LearningFile> LearningFile
        {
            get { return this._LearningFile ?? (this._LearningFile = new HashSet<LearningFile>()); }
            set { this._LearningFile = value; }
        }
    }
}
